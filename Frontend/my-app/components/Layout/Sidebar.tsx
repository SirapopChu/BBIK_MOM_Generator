        ...
        <>
            <div className={`${styles.sidebar} ${isOpen ? styles.sidebarOpen : ''}`}>
                ...
                <nav className={styles.nav}>
                    <a href="#" className={`${styles.navItem} ${styles.activeNavItem}`} onClick={(e) => { e.preventDefault(); router.push('/dashboard'); }}>
                        <span className={styles.icon}>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                        </span>
                        {dict.common.dashboard}
                    </a>
                    <a href="#" className={styles.navItem} onClick={(e) => { e.preventDefault(); router.push('/dashboard/new-meeting'); }}>
                        <span className={styles.icon}>
                    ...
                    <a href="#" className={styles.navItem} onClick={(e) => { e.preventDefault(); router.push('/dashboard/processing-queue'); }}>
                        <span className={styles.icon}>
                    ...
                    <a href="#" className={styles.navItem} onClick={(e) => { e.preventDefault(); router.push('/dashboard/settings'); }}>
                        <span className={styles.icon}>
