    ...
    const RecordingView = () => (
            <div className={styles.recordingMode}>
                ...
                <div className={styles.recordingTopBar}>
                    ...
                    <div className={styles.recordingTopRight}>
                        <div className={styles.topUserInfo}>
                            <div className={styles.topUserName}>Tipakorn S.</div>
                            <div className={styles.topUserRole}>Senior Project Management Consultant</div>
                        </div>
                        <div className={styles.topAvatar}>T</div>
                    </div>
                </div>
                    ...
                    <div className={styles.recordingMainGrid}>
                            ...
                            <div className={styles.timerCardPro}>
                                ...
                                <div className={styles.waveBox}>
                                    {Array.from({ length: 45 }).map((_, i) => (
                                        <div key={i} className={styles.waveBarPro} style={{ height: `${Math.random() * 60 + 10}%`, animationDelay: `${Math.random()}s` }}></div>
                                    ))}
                                </div>
                        ...
                        <div className={styles.recordingMainRight}>
                            ...
                            <div className={styles.stickyNote}>
                                <div className={styles.stickyNoteTitle}>Realtime Noise Reduction</div>
                                <div className={styles.stickyNoteDesc}>(Research realtime audio quality checking)</div>
                                <div className={styles.stickyNoteUser}>
                                    <div className={styles.stickyNoteAvatar} style={{ backgroundImage: 'url("https://ui-avatars.com/api/?name=Sirapop+C&background=1e293b&color=fff")' }}></div>
                                    <span>Sirapop Chullapasorn</span>
                                </div>
                            </div>
                        </div>
                    </div>
